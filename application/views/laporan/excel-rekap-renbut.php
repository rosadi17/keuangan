...
<table width="100%">
    <tr>
        <td colspan="10">REKAP RENCANA KEBUTUHAN <?= strtoupper(tampil_bulan($bulan)).' '.$tahun ?></td>
    </tr>
</table>
<table cellspacing="0" width="100%" border="1">
    ...
    <tr class="<?= ($key%2==1)?'even':'odd' ?>">
        ...
        <td align="right"><?= formatcurrency($data->nominal) ?></td>
        <td align="right"><?= formatcurrency($data->cashbon) ?></td>
        <td align="right"><?= formatcurrency($data->jml_renbut) ?></td>
        <td><?= $data->penerima ?></td>
    </tr>
    <?php } ?>
</table>